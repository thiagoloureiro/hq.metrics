...
namespace hq.metrics.Reporting
{
    ...
    public class SampledFileReporter : ReporterBase
    {
        ...
        public SampledFileReporter(HealthChecks healthChecks, IDateTimeOffsetProvider dateTimeOffsetProvider = null) : this("", Encoding.UTF8, new HumanReadableReportFormatter(healthChecks), dateTimeOffsetProvider) { }
        public SampledFileReporter(Encoding encoding, HealthChecks healthChecks, IDateTimeOffsetProvider dateTimeOffsetProvider = null) : this("", encoding, new HumanReadableReportFormatter(healthChecks), dateTimeOffsetProvider) { }
        public SampledFileReporter(string directory, HealthChecks healthChecks, IDateTimeOffsetProvider dateTimeOffsetProvider = null) : this(directory, Encoding.UTF8, new HumanReadableReportFormatter(healthChecks), dateTimeOffsetProvider) { }
        public SampledFileReporter(string directory, Encoding encoding, HealthChecks healthChecks, IDateTimeOffsetProvider dateTimeOffsetProvider = null) : this(directory, encoding, new HumanReadableReportFormatter(healthChecks), dateTimeOffsetProvider) { }
