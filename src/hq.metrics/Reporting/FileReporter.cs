...
namespace hq.metrics.Reporting
{
    public class FileReporter : ReporterBase
    {
        ...
        public FileReporter(string path, HealthChecks healthChecks) : base(new StreamWriter(new FileStream(path, FileMode.Append), Encoding.UTF8, 8024, true), healthChecks) { }
        public FileReporter(string path, Encoding encoding, HealthChecks healthChecks) : base(new StreamWriter(new FileStream(path, FileMode.Append), encoding, 8024, true), healthChecks) { }
